...
Options:
  ...
  -t, --theme THEME    Override colourscheme (default: gruvbox)
  --install-tools      Headless install of Mason tools (shfmt, shellcheck, bash-language-server, pyright, lua-language-server, ruff-lsp)
  -h, --help           Show this help
...
" ► Theme & UI (icons first)
Plug 'nvim-tree/nvim-web-devicons'

" Mark UI-heavy plugins as OPTIONAL so they are not auto-loaded during
" headless PlugInstall. They will be `packadd`-ed in interactive sessions.
Plug 'akinsho/bufferline.nvim', { 'tag': '*', 'opt': 1 }
Plug 'goolord/alpha-nvim',      { 'opt': 1 }
Plug 'folke/noice.nvim',        { 'opt': 1 }
Plug 'nvim-tree/nvim-tree.lua', { 'opt': 1 }
