...
#
# Usage: ./setup_nvim_v6.sh [-b | --backup] [-t THEME]
#
# Options:
...
"==============================================================================
" init.vim — generated by setup_nvim_v6.sh
"==============================================================================
...
call plug#begin('~/.vim/plugged')
  ...
  Plug 'nvim-lua/popup.nvim'            " Popup API implementation
  ...
  Plug 'williamboman/mason.nvim'        " Installer for LSP/DAP/Linters
  ...
  Plug 'windwp/nvim-autopairs'          " Autoclose brackets and quotes
...
nnoremap <leader>fg :Telescope git_files<CR> " Git file search
...
echo "✅ Neovim setup with chosen theme and enhanced plugins complete!"
